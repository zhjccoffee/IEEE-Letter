...
\begin{figure*}[!t]
\centerline{\includegraphics[width=\textwidth]{framework_overview_recomposed.png}}
...
residual-reflex-informed controller. In the enlarged lower row, panel (b2) on
the left shows the sparse phase-dependent reflex topology, while panel (b1) on
...
sensory feedback. Magenta entries in (b2) denote the four reflex parameters
...
EarlyStance--LateStance, and Liftoff--Swing--Landing, respectively. The
