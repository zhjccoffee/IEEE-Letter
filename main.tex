...
A key distinction therefore lies not only in how reinforcement learning is performed, but also in what the policy is required to learn. Existing reinforcement learning approaches typically formulate muscle actions as the direct output of the policy. However, while task rewards define what should be achieved, they do not uniquely determine how muscles should be coordinated to achieve it. As a result, the policy is required to rediscover complex neuromuscular coordination solely from task rewards.
